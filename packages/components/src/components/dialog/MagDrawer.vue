<template>
  ...
  >
    ...
    <template #footer>
      <div
          v-if="dialogConfig.showConfirmBtn || dialogConfig.showCancelBtn"
          class="mag-drawer__footer"
          :class="{
...
import {MagDialogModel} from '@/types';
  ...
  setup(props, {emit, expose}) {
    ...
    const dialogConfig = computed(() => {
      ...
      return {
        ...
        width: model.fullscreen ? '100%' : (model.width || '30%'),
